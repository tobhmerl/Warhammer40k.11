...
## Project Guidelines
- For this repo (Warhammer40k.11), ignore architecture changes proposed in specs (e.g., new projects like TombForge.UI/TombForge.Data, SQLite, MAUI/native). Always translate new requirements into the existing architecture: Blazor WASM (Warhammer40k.11) + Azure Functions isolated API (Warhammer40k.Api) + shared Warhammer40k.Core + Azure Table Storage persistence, with SWA built-in auth.
